...
@Component
public class TerapevtAppointmentCommand extends  DoctorsAppointmentCommand implements ProcessCommand {
    ...
    public SendMessage start(Update update) {
        ...
        appointment.setDoctor(Doctors.TERAPEVT);
    ...
    public SendMessage sendDefaultMessage(Update update) {
        ...
        List<String> appointmentTime = AppointmentHelper.getFreeIntervals(Doctors.TERAPEVT);
