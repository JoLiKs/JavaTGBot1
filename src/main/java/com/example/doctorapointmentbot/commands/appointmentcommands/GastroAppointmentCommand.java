...
@Component
public class GastroAppointmentCommand extends DoctorsAppointmentCommand implements ProcessCommand {
    SendMessage message = new SendMessage();

    @Override
    public SendMessage start(Update update) {
        if (!update.getMessage().getText().equals("Гастроэнтеролог")) {
            return null;
        }
        ...
        appointment.setDoctor(Doctors.GASTROENTEROLOG);
    ...
    public SendMessage sendDefaultMessage(Update update) {
        ...
        List<String> appointmentTime = AppointmentHelper.getFreeIntervals(Doctors.GASTROENTEROLOG);
