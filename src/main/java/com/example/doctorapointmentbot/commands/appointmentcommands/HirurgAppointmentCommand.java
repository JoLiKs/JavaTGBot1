...
@Component
public class HirurgAppointmentCommand extends DoctorsAppointmentCommand implements ProcessCommand {
    ...
    public SendMessage start(Update update) {
        ...
        appointment.setDoctor(Doctors.HIRURG);
    ...
    public SendMessage sendDefaultMessage(Update update) {
        ...
        List<String> appointmentTime = AppointmentHelper.getFreeIntervals(Doctors.HIRURG);
